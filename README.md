...
```python
from ApolloTab.audio import MidiConverter, SynthEngine, MetronomeConfig
...
events_with_metronome = converter.convert(song, track_index=0, metronome_config=config)
engine.load_events(events_with_metronome, bpm=song.tempo)
```
